"""strippee_19912 URL Configuration
...
admin.site.site_header = "strippee"
admin.site.site_title = "strippee Admin Portal"
admin.site.index_title = "strippee Admin"

# swagger
api_info = openapi.Info(
    title="strippee API",
    default_version="v1",
    description="API documentation for strippee App",
)
